...
namespace FastColoredTextBoxNS
{
    ...
    {
        //styles
        static SolidBrush myBrush = new SolidBrush(Color.FromArgb(86, 156, 211));
        protected static readonly Platform platformType = PlatformType.GetOperationSystemPlatform();
        public readonly Style BlueBoldStyle = new TextStyle(myBrush, null, FontStyle.Bold);
        public readonly Style BlueStyle = new TextStyle(myBrush, null, FontStyle.Regular);
